...
REQUIRED_FILES = {
    ...
    "src/supportability_audit/s08_refactor.py",
    ...
    "tests/characterization/s08-refactor-contract.characterization.py",
    "tests/characterization/s08-refactor-contract.golden.json",
