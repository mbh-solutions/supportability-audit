...
s08_refactor = importlib.import_module("supportability_audit.s08_refactor")
...
class RepositoryValidationTests(unittest.TestCase):
    ...
    def test_s08_refactor_contract(self) -> None:
        self.assertEqual("s08-refactor", s08_refactor.S08_REFACTOR)
