...
REQUIRED_FILES = {
    ...
    "src/supportability_audit/s06_component.py",
    ...
    "tests/characterization/s06-component-contract.characterization.py",
    "tests/characterization/s06-component-contract.golden.json",
